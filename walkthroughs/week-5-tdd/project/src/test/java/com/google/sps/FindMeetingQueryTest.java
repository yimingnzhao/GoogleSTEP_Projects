...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeWithConflictNotInvited() {
    // Have each person have different events and one optional attendee who cannot attend
    //
    // Events   :       |--A--|     |--B--|
    // Optional : |--------------C--------------|
    // Day      : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeWithoutConflictInvited() {
    // Have each person have different events and one optional attendee who cannot attend
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
  ...
  public void notEnoughRoomForOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting, but the optional cannot attend
    //
    // Events  : |--A--|     |----A----|
    // Optional:       |--B--|
    // Day     : |---------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)), 
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, DURATION_30_MINUTES, false),
            Arrays.asList(PERSON_B)));
  ...
  @Test
  public void notEnoughRoomForOnlyOptional() {
    // Have one person, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Optional: |--A-----| |-----A----|
